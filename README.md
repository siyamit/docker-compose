...
2. Use the configuration generators available from [siyamit' cache-domains](https://github.com/siyamit/cache-domains) project to create configuration data to load into your network's existing DNS infrastructure
...
# More information
The LanCache docker-stack is generated automatically from the data over at [siyamit](https://github.com/siyamit/cache-domains). All services that are listed in the UKLans repository are available and supported inside this docker-compose.
